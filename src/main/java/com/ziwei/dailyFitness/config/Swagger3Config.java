...
public class Swagger3Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.ziwei.dailyFitness.controller"))
...
//                  regex(String regex)：按照正则表达式匹配 API 接口。
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Swagger UI demo for DailyFitness")
                .description("Springboot Project following DailyFitness")
                .version("1.0")
                .build();
    }
